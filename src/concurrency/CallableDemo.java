...
//		int nextInt = r.nextInt(3000);
		...
		return "result of TaskWithResult " + id + ",sleep time:" + nextInt;
//		return "result of TaskWithResult " + id + ",Threadname:" +  Thread.currentThread().getName();
	}
}
